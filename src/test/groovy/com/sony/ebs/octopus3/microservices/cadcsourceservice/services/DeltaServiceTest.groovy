...
class DeltaServiceTest {
    ...
    StubFor mockDeltaCollaborator, mockHttpClient
    ...
    void before() {
        ...
        mockHttpClient = new StubFor(NingHttpClient)
    }

    void runFlow(List expected) {
    ...
    void "success"() {
        ...
        runFlow(["success for urn:global_sku:score:en_gb:a", "success for urn:global_sku:score:en_gb:b", "success for urn:global_sku:score:en_gb:c"])
    }
